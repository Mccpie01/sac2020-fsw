 ...
 *
 * @file      sac2020_anthem.h
 * @purpose   An absolutely mission-critical file that plays the USSR national
 *            anthem on the flight computer's buzzer as it is loaded into the
 *            rocket. Thanks to Ömer Arda Kaya for this work of art.
 *            https://github.com/Aorda/USSR-Anthem-with-Arduino-Piezo-Buzzer
 * @author    Ömer Arda Kaya, Stefan deBruyn
 * @updated   2/23/2020
 */

#ifndef SAC2020_ANTHEM_H
#define SAC2020_ANTHEM_H
...
void anthem(void *k_unused)
{
  size_t melody_length = sizeof(melody) / sizeof(melody[0]);
  for (size_t thisNote = 0; thisNote < melody_length; thisNote++)
  {
